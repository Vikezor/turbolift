...
//    	console.log(o.type, o.item);
    ...
    var model_floorplan = blueprint3d.model.building.floors[floor];
...
//		gui.closed = true;
	...
	{
		blueprint3d.model.building.floors[floor].update();
		$('.card').flip(true);
//		gui.closed = false;
		$(this).addClass('active');
